...
exports.executeHttpRequest_customDestination = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, http_client_1.executeHttpRequest)({
 ...
 */
var _serviceBindingTransformFn = function (service) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, connectivity_1.getClientCredentialsToken)(tempService)];
            case 1:
                token = (_a.sent());
...
function _buildClientCredentialsDestination(token, url, name) {
    var expiresIn = Math.floor(((0, connectivity_1.decodeJwt)(token).exp * 1000 - Date.now()) / 1000).toString(10);
    return {
        url: url,
        name: name,
